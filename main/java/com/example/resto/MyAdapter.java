...
public class MyAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public MyAdapter(Context context, List<DataClass> dataListFood) {
        this.context = context;
        this.dataList = dataListFood;
       ...
       holder.recName.setText(dataList.get(position).getDataName());
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("Category",dataList.get(holder.getAdapterPosition()).getDataCategories());
